...
$OMEGAPD (4, FIXED)     ; df for OMEGA prior
...
$EST MAXEVAL=1 METHOD=NUTS INTERACTION CTYPE=0 OLKJDF=2 OVARF=1 NUTS_DELTA=0.95 NBURN =0 NITER = 0 SEED=112019 PRINT=1 NOABORT THIN = 1 RANMETHOD=P PARAFPRINT=10000 BAYES_PHI_STORE=1

$SIML (11229589) (52045789) SUBPROBLEMS=250 TRUE=PRIOR
