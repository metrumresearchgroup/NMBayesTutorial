...
$EST METHOD=CHAIN FILE=../2004.CHN NSAMPLE=0 ISAMPLE=3 SEED=1 CTYPE=0 IACCEPT=0.25 DF=10 DFS=0

$EST MAXEVAL=9999 METHOD=NUTS INTERACTION AUTO=2 CTYPE=0 OLKJDF=2 OVARF=1 NUTS_DELTA=0.95 NBURN = 1000 NITER = 2000 SEED=3 PRINT=1 NOABORT THIN = 1 RANMETHOD=P PARAFPRINT=10000 BAYES_PHI_STORE=1
