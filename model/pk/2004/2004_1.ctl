$PROBLEM From bbr: see 2004.yaml for details
...
( 4.29  FIX)     ;  THETA(3) Q
( 7.07  FIX)     ;  THETA(4) V3
( -0.925)    ;  THETA(5) KA; log(exp(-1.33)*1.5) increase by 50% 
...
$EST METHOD=CHAIN FILE=../2004.CHN NSAMPLE=0 ISAMPLE=1 SEED=1 CTYPE=0 IACCEPT=0.25 DF=10 DFS=0

$EST MAXEVAL=9999 METHOD=NUTS INTERACTION AUTO=2 CTYPE=0 OLKJDF=2 OVARF=1 NUTS_DELTA=0.95 NBURN = 1000 NITER = 2000 SEED=1 PRINT=1 NOABORT THIN = 1 RANMETHOD=P PARAFPRINT=10000 BAYES_PHI_STORE=1

$TABLE NUM CL V2 Q KA V3 ETAS(1:LAST) EPRED IPRED NPDE EWRES NOPRINT ONEHEADER FILE=./2004.tab
